...
\acro{cnmp}[CNMP]{Code Noise and Multipath}
...
\acro{gbas}[GBAS]{Ground Based Augmentation System}
\acro{geo}[GEO]{Geostationary Earth Orbit}
\acro{give}[GIVE]{Grid Ionospheric Vertical Error}
...
\acro{ils}[ILS]{Instrument Landing System}
\acrodefplural{ils}[ILSes]{Instrument Landing Systems}
...
\acro{lgf}[LGF]{\ac{laas} Ground Facility}
\acro{lpv}[LPV]{Localizer Performance with Vertical Guidance}
...
\acro{rfu}[RFU]{Radio Frequency Uplink}
...
\acro{sep}[SEP]{Spherical Error Probable}
...
\acro{sps}[SPS]{Standard Positioning Service}
...
\acro{vor}[VOR]{\ac{vhf} Omnidirectional Range}
\acro{waas}[WAAS]{Wide-Area Augmentation System}
\acro{wms}[WMS]{Wide-Area Master Station}
\acrodefplural{wms}[WMSes]{Wide-Area Master Stations}
\acro{wre}[WRE]{Wide-Area Reference Equipment}
\acro{wrs}[WRS]{Wide-Area Reference Station}
\acrodefplural{wrs}[WRSes]{Wide-Area Reference Stations}
\acro{wsf}[WSF]{WAAS Support Facility}
\acro{wss}[WSS]{WAAS Support Services}
\acro{wum}[WUM]{WAAS User Message}
\acrodefplural{wum}[WUMs]{WAAS User Messages}
\acro{udre}[UDRE]{User Differential Range Error}
\end{acronym}
